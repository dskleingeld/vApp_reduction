...
Here we use not one apperture function as in \autoref{sec:PSF} but combine three. The first two ($Ae^{\pm i\theta}$) simulate the opposing phases the circular polarisations receive from the \ac{vAPP} (see \autoref{sec:vapp}). The third factor, is called the leakage term.
%TODO [optional] annotated version of vapp psf ipv clean vapp psf
...
\begin{figure}[h!]
  ...
  \begin{minipage}[t]{1.3\textwidth}
      ...
      \begin{subfigure}[b]{0.6\textwidth}
        ...
        \caption{On sky \ac{PSF}: 1th - 2th, *** seconds difference.}
      \end{subfigure}      
      ...
      \begin{subfigure}[b]{0.6\textwidth}
        ...
        \caption{On sky \ac{PSF}: 1th - 10th, *** seconds difference.}
      \end{subfigure}
      ...
      \begin{subfigure}[b]{0.6\textwidth}
        ...
        \caption{On sky \ac{PSF}: 1th - 50th, *** seconds difference.}
      \end{subfigure}
