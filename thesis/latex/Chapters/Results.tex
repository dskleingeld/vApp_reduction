...
\begin{figure}[h!]
  ...
  \begin{minipage}[t]{1.2\textwidth}
      \begin{subfigure}[t]{0.6\textwidth}
        ...
        \caption{The coronagraphic \ac{PSF} used to create c d e and f, the brightness is relative to the center star}
...
\begin{figure}[h!]
  ...
  \begin{minipage}[t]{1.2\textwidth}
      ...
      \begin{subfigure}[t]{0.6\textwidth}
        ...
        \caption{A lower contrast standard disk model. Here the contrast between star and disk has been halved by doubling the disks surface brightness. The images straight below are generated using this model.}
        \label{fig:C1}
        \label{fig:disk8_1}
      \end{subfigure}
...
\begin{figure}[h!]
  ...
  \caption{Comparing a large and small disk. Both columns from top to bottom: the disk, \ac{ADI} applied to a simulated image of only disk and not the star, \ac{ADI} applied to a simulated image of the disk and star.}
...
\begin{figure}[h!]
  ...
  \begin{minipage}[t]{1.2\textwidth}
      ...
      \begin{subfigure}[t]{0.6\textwidth}
        ...
        \caption{\ac{ADI} applied to an image generated of the above model (b). As it had a lower initial field rotation the coronagraphic \ac{PSF} was rotated back less then normally during \ac{ADI} which causes the difference in orientation compared to \ref{fig:disk4_6}}
        \label{fig:disk5_3}
      \end{subfigure}
  \end{minipage}
  }%

  \caption{Comparing two disks with different initial field rotation. Both columns from top to bottom: the disk, \ac{ADI} applied to a simulated image of only disk and not the star, \ac{ADI} applied to a simulated image of the disk and star.}
  \label{fig:comp_incl}
\end{figure}
