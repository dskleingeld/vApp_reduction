...
\begin{figure}[h!]
  ...
  \begin{minipage}[t]{1.2\textwidth}
      \begin{subfigure}[t]{0.6\textwidth}
        ...
        \caption{The coronographic \ac{PSF} used to create c d e and f, the brightness is relative to the center star}
...
\begin{figure}[h!]
  ...
  \begin{minipage}[t]{1.2\textwidth}
      ...
      \begin{subfigure}[t]{0.6\textwidth}
        ...
        \caption{\ac{ADI} applied to an image generated of the above model (b). As it had a lower initial field rotation the coronograpic \ac{PSF} was rotated back less then normally during \ac{ADI} which causes the difference in orientation compared to \ref{fig:disk4_6}}
        \label{fig:disk5_3}
      \end{subfigure}
  \end{minipage}
  }%
