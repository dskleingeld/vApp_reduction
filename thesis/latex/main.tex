...
\include{Chapters/DataGeneration} % Chapter 3
\include{Chapters/DataReduction} % Chapter 4
\include{Chapters/Results} % Chapter 5
\include{Chapters/Discussion} % Chapter 6
\include{Chapters/FutureWork} % Chapter 6
...
\include{FrontBackMatter/Appendix} % Bibliography
