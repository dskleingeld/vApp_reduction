...
\include{Chapters/Chapter01} % Theory
\include{Chapters/Chapter02} % Generating observations
\include{Chapters/Chapter03} % Reductie Methodes
\include{Chapters/Chapter04} % Resultaten
